...
<div class="wrapper">
    ...
    <div class="main-panel">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Approved Doctor List</h4>
                                <p class="category"> Search by doctor name, speciality, BMDC Reg.no</p>
       ...
       <?php
         ...
         $chamber_id = $doctor_id =$district = $area = $consultation_center = $additional_note = $new_fee = $returning_fee = $report_fee = "";
           ...
           $query1 = "select * from doctor where approve=0";
          ...
          $offset = $page * $limit - $limit ;
           ...
           $query = "select * from doctor where approve=0 limit $limit offset $offset";
	...
	?>
                                        ...
                                        <tr>
                                           ...
                                           <td> <a href="approved_info.php?id=<?php echo $doctor_id ?>" class="btn btn-info view_ads"><i class="fa fa-eye" aria-hidden="true"></i></a> </td>
                                        </tr>
                                              <?php }  ?>
                                      <!--  <tr>
                                        	<td>2</td>
                                        	...
                                        	<td>Dermatology</td>
                                        	<td>2002</td>
                                           <td> <a href="approved_info.php" class="btn btn-info view_ads"><i class="fa fa-eye" aria-hidden="true"></i></a> </td>
                                        </tr>
                                        <tr>
                                        	<td>3</td>
                                        	<td>Dr. Touhidual Islam Imdad</td>
